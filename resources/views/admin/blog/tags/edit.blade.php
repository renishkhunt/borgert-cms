...
@section('title',  trans('admin/blog.tags.edit.title'), @parent)

@section('actions')
	<a href="{{ route('admin.blog.tags.index') }}" class="btn btn-default"><i class="fa fa-angle-left"></i> @lang('admin/_globals.buttons.back')</a>
@endsection

@section('blog')
	
	@section('subtitle',  trans('admin/blog.tags.edit.title'))
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10"><input type="text" name="title" class="form-control" value="{{ $tag->title }}"></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">@lang('admin/_globals.forms.order'):</label>
                                <div class="col-sm-10"><input type="number" min="0" name="order" class="form-control" value="{{ $tag->order }}"></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">@lang('admin/_globals.forms.status'):</label>
                                <div class="col-sm-10">
                                    <input type="checkbox" name="status" class="js-switch" value="1" {{ $tag->status === 1 ? 'checked' : '' }} />
                                </div>
                            </div>
                            <div class="form-group">
